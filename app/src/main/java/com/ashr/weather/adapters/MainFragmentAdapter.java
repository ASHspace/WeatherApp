...
public class MainFragmentAdapter extends RecyclerView.Adapter<ForecastMasterViewHolder> {
    @Nullable
    public static List<Datum> weeklyForecast;
    private LayoutInflater inflater;
    private Context context;

    public MainFragmentAdapter(@Nullable List<Datum> weeklyForecast, Context context) {
